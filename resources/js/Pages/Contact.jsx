...
export default function Contact() {
    ...
    return (
        ...
        <div className="text-center">
            {/* Button to show the contact form */}
            
            <button 
                className="text-white mt-40 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" 
                type="button" 
            ...
            {/* Drawer component */}
            <div className={`fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform ${isDrawerOpen ? 'translate-x-0' : '-translate-x-full'} bg-white w-80 dark:bg-gray-800`} tabindex="-1" aria-labelledby="drawer-contact-label">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                    <a href="tel:2124567890" className="hover:underline">212-456-7890</a>
                </p>
            </div>
        </div>
    </div>
